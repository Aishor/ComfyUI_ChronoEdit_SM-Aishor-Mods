...
try:
    ...
    diffusers_vrsion_low=False
except:
    diffusers_vrsion_low=True
...
def load_model(model_name):
    ...
    if  "Qwen2.5-VL-7B-Instruct" in model_name:
    ...
    elif "Qwen3-VL-30B-A3B-Instruct" in model_name:
        if not diffusers_vrsion_low:
...
def enhance_prompt(input_image, input_prompt, model, processor, max_resolution=1080):
    """
